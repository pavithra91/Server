...
const { getDonationRules, updateRule, deleteRule, addRule, getDonationBadges, sendEmail, getUserChat, sendChatMessage, getAdminDashboardDetails } = require('../controller/miscController');
